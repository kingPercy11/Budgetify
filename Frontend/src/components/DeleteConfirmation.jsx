...
const DeleteConfirmation = ({ isOpen, onClose, onConfirm, expenseAmount, expenseCategory }) => {
  ...
  return (
    <div className='fixed inset-0 bg-black/70 backdrop-blur-md flex items-center justify-center z-50'>
      <div className='bg-gradient-to-br from-red-50 to-red-100 rounded-3xl shadow-2xl p-8 w-full max-w-md mx-4 relative border border-red-200'>
        {/* Warning Icon */}
        ...
        <div className='flex gap-3'>
          ...
          <button
            type='button'
            onClick={onConfirm}
            className='flex-1 px-6 py-3 bg-gradient-to-r from-red-500 to-red-600 text-white font-bold rounded-xl hover:from-red-600 hover:to-red-700 transition-all duration-300 shadow-lg hover:shadow-xl hover:scale-105'
          >
            Delete
          </button>
        </div>
